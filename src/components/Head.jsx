...
const Head = () => {
    // used react useState hook to remeber if the date model is open or not
    ...
    // by default room and adult is defined as 1, children as 0.
    ...
    // used navigate hook to send user provided data to othe hotel component
    // for price calculation etc.
    ...
    return (
        // search form using bootstrap and tailwind css
        <div className="head">
            ...
            <div className='search'>
                ...
                <div className="bookItems">
                    ...
                    {/* 
                    used to select element so user can choose value form 1-10
